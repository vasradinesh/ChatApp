...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_SENT) {
            ...
            return new ReceiveMessageViewHolder(
                    IconContainerReciveMessageBinding.inflate(
                            LayoutInflater.from(parent.getContext()),
                            parent,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == VIEW_TYPE_SENT) {
            ...
            ((ReceiveMessageViewHolder) holder).setData(chatMessage, receiverProfileImage);
        }
    }
    ...
    static class ReceiveMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private final IconContainerReciveMessageBinding binding;

        ReceiveMessageViewHolder(IconContainerReciveMessageBinding binding) {
            super(binding.getRoot());
            this.binding = binding;
        }
